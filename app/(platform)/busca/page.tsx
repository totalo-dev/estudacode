...
export default function BuscaPage() {
  ...
  // Sincroniza query com parâmetro da URL
  useEffect(() => {
    const q = searchParams.get("q") || "";
    setQuery(q);
  }, [searchParams]);

  // Atualiza a URL ao digitar (debounce simples)
        ...
        {mostrarTrilhas && (
          <section>
            ...
            {trilhasFiltradas.length > 0 ? (
              ...
              mostrarTrilhas && query && (
                <p className="text-secondary text-sm">Nenhuma trilha encontrada.</p>
              )
            )}
          </section>
        )}
        ...
        {mostrarProjetos && (
          <section>
            ...
            {projetosFiltrados.length > 0 ? (
              ...
              mostrarProjetos && query && (
                <p className="text-secondary text-sm">Nenhum projeto encontrado.</p>
              )
            )}
          </section>
        )}
