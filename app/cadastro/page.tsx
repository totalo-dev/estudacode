...
export default function CadastroPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    // Cadastro mockado para o frontend
    setIsLoading(true);
    setTimeout(() => {
      setIsLoading(false);
      setCadastrado(true);
      // Seta o cookie logo após o cadastro para liberar o acesso ao onboarding
        ...
        {!cadastrado ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Erro */}
              {erro && (
                <p className="text-sm text-red-400 bg-red-400/10 px-4 py-2.5 rounded-lg">
                  {erro}
                </p>
              )}
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" className="flex items-center justify-center space-x-2 px-4 py-2.5 rounded-lg border border-card bg-surface text-text hover:bg-card transition-colors text-sm font-medium">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-secondary mb-2">Bem-vindo à EstudaCode, <span className="text-text font-medium">{form.nome}</span>.</p>
            <p className="text-secondary text-sm mb-8">Verifique seu e-mail para confirmar o cadastro.</p>
